                    ...
                    <div class="col-sm-8 col-lg-8 col-xl-9 col-xxl-8">     
                        <div class="py-md-5 py-3">
                            ...
                            <div class="text-center mb-5">
                                ...
                                <small class="text-muted">Login to start reaching with your community.</small>
                            </div>
                            <form action="{{route('login-user')}}" method="post">
                                ...
                                <!-- Password -->
                                <div class="mb-3">
                                    <div class="float-end" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom" title="Click to recover your access">
                                        <small>
