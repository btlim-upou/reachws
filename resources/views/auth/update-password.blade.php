                ...
                <div class="row justify-content-center my-auto">
                    <div class="col-sm-8 col-lg-8 col-xl-9 col-xxl-8">     
                        <div class="py-md-5 py-4">       
                            ...
                            <!-- Input Form -->
                            <form action="{{ route('update-password') }}" method="POST" class="pt-2">
                                ...
                                @if (!session('status'))
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="old_password" type="password" class="form-control" id="txtOldPassword" placeholder="Enter Old Password"
                                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" title="Enter your old password">
                                        @error('old_password')
                                    ...
                                    <div class="text-center mt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-6" title="Click to save changes">
                                                ...
                                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom" title="Click to save your changes">Update</button>
                                            </div>

                                            <!-- Back Button -->
                                            <div class="col-6 mx-auto" title="Click to go back">
                                                <a href="/" class="btn btn-light w-100" type="button"
                                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom" title="Go back home">Go Back</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!-- Save Button -->                                      
                                <div class="mt-4 mx-auto" title="Click to save changes">
                                    <a href="/" class="btn btn-primary w-100"
                                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom" title="Click to go back to home page">Return to Home</a>
                                </div>
