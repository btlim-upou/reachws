...
<script>
    ...
    channel.bind('message-sent', function(msg_) {
        if(room_id == msg_.message.room_id) {
            if(user_id != msg_.message.sent_by) {
                new_message = `
                <li class="chat-list left" id="1">
                    <div class="conversation-list">
                      <div class="user-chat-content">
                        <div class="ctext-wrap">
                          <div class="ctext-wrap-content">
                              <small class="text-indigo">` + msg_.sender.nick_name +`</small>
                              <i><small class="text-muted">` + msg_.message.created_at.toLocaleString() +`</small></i>
                              <p class="mb-0 ctext-content">` + msg_.message.message + `</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <li class="chat-list right" id="1">
                    <div class="conversation-list">
                      <div class="user-chat-content">
                        <div class="ctext-wrap">
                          <div class="ctext-wrap-content">
                              <small>` + msg_.sender.nick_name +`</small>
                              <i><small class="text-muted">` + msg_.message.created_at.toLocaleString() +`</small></i>
                              <p class="mb-0 ctext-content">` + msg_.message.message + `</p>
                          </div>
                        </div>
